...
export default function TabNavigation({ activeTab, onTabChange }) {
  ...
  return (
    <>
      <aside className={`hidden md:flex fixed top-0 right-0 h-screen z-50 border-l border-gray-200 dark:border-slate-800 bg-white/96 dark:bg-slate-950/96 backdrop-blur-xl flex-col transition-all duration-300 px-1 py-3 ${collapsed ? 'w-[5.75rem]' : 'w-[19rem]'}`} dir="rtl">
