...
export default function SuggestedQuestions({ onSelectQuestion }) {
  const questions = [
    'אילו כלי AI מומלצים לעיבוד תמונות?',
    'מה ההבדל בין ChatGPT ל-Claude?',
    'תן לי המלצה לכלי פרודוקטיביות',
    'אילו כלי AI חינמיים מומלצים למתחילים?',
    'מה הכלי הטוב ביותר ליצירת וידאו?',
    'תסביר לי על כלי אוטומציה מתקדמים',
  ];
